...
Codec.prototype.encodeRequest = function (invoker, method, args) {
    var body = this._serializeBody(invoker, method, args);
 ...
 * @public
 */
Codec.prototype.clearChunck = function () {
    this._chunks = [];
};
 ...
 * @returns {boolean}
 */
Codec.prototype.pushChunck = function (chunk) {
    var self = this;
 ...
 * @private
 */
Codec.prototype._codecHead = function (length) {
 ...
 * @private
 */
Codec.prototype._serializeBody = function (invoker, method, args) {
